    ...
    <section>
      <Element>
        <div className='container'>
          ...
          {/* pricing */}
          <div className='scroll-hide relative z-2 -mt-12 flex items-start max-xl:overflow-auto max-xl:pt-6 gap-5'>
            {plans.map(({id, title, priceMonthly, priceYearly, caption, features, icon, logo},index)=>(
              ...
              >
                {index === 1 && (
                  <div className='g4 absolute h-330 left-0 right-0 top-0 rounded-tl-3xl rounded-tr-3xl z-1'/>
                )}
                ...
                <div className={clsx(
                  ...
                  <div className='relative z-2 flex items-center justify-center'>
                    ...
                    <div className='small-1 relative top-3 ml-1'>
                      /mo
                    </div>
                  </div>
                </div>
